...
require('lazy').setup({
...

  {
    ...
    config = function()
      ...
      vim.api.nvim_set_keymap('n', '<leader>gs', ':Git status<CR>', { noremap = true, silent = true, desc = 'git [S]tatus' })
      vim.api.nvim_set_keymap('n', '<leader>ga', ':Git add .<CR>', { noremap = true, silent = true, desc = 'git [A]dd .' })
      vim.api.nvim_set_keymap('n', '<leader>gcm', ':Git commit<CR>', { noremap = true, silent = true, desc = 'git [C]ommit [M]essage' })
      vim.api.nvim_set_keymap('n', '<leader>gp', ':Git push<CR>', { noremap = true, silent = true, desc = 'git [P]ush' })
      vim.api.nvim_set_keymap('n', '<leader>gl', ':Git pull<CR>', { noremap = true, silent = true, desc = 'git pu[L]l' })
      vim.api.nvim_set_keymap('n', '<leader>gb', ':Git branch<CR>', { noremap = true, silent = true, desc = 'git [B]ranch' })
      ...
      vim.api.nvim_set_keymap('n', '<leader>gco', ':Git checkout ', { noremap = true, silent = true, desc = 'git [C]heck[O]out' })
    end,
  },
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    config = function() -- This is the function that runs, AFTER loading
      ...
      require('which-key').register {
        ...
        ['<leader>gc'] = { name = 'git [C]ommit or [C]heckout', _ = 'which_key_ignore' },
...

  {
    ...
    init = function()
      ...
      vim.cmd [[
        ...
        hi InactiveWindow guibg=#1f1a1a
